        ...
        {isGenerating ? (
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <div className="mt-6 flex gap-4 justify-end">
              <button
                onClick={() => {
                  const blob = new Blob([coverLetter.replace(/<[^>]+>/g, '')], { type: 'text/plain' });
                ...
                className="px-4 py-2 text-sm rounded-lg border border-indigo-600 text-indigo-600 hover:bg-indigo-50 transition-colors"
              >
                Download as Text
              </button>
              <button
                onClick={() => window.print()}
                className="px-4 py-2 text-sm rounded-lg text-white hover:bg-indigo-700 transition-colors"
